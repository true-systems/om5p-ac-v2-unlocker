...
{ 
   ...
   /*
    ...
    printf(MODULE_NAME": unit %d phy addr %x ", ethUnit, ATHR_PHYADDR(phyUnit));
}
...
athr_phy_setup(int ethUnit,int phyUnit)
{
	...
	#ifdef CONFIG_AR8035_PHY
	phy_reg_write(ethUnit, ATHR_PHYADDR(phyUnit), ATHR_DEBUG_PORT_ADDRESS, 0x12);
	phy_reg_write(ethUnit, ATHR_PHYADDR(phyUnit), ATHR_DEBUG_PORT_DATA, 0x480c);
	phy_reg_write(ethUnit, ATHR_PHYADDR(phyUnit), ATHR_DEBUG_PORT_ADDRESS, 0xb);
	phy_reg_write(ethUnit, ATHR_PHYADDR(phyUnit), ATHR_DEBUG_PORT_DATA, 0xbc20);
	phy_reg_write(ethUnit, ATHR_PHYADDR(phyUnit), ATHR_DEBUG_PORT_ADDRESS, 0x0);
	phy_reg_write(ethUnit, ATHR_PHYADDR(phyUnit), ATHR_DEBUG_PORT_DATA, 0x824e);
	#else /* AR8021_PHY */
	phy_reg_write(ethUnit, ATHR_PHYADDR(phyUnit), ATHR_DEBUG_PORT_ADDRESS, 0x0);
	...
	phy_reg_write(ethUnit, ATHR_PHYADDR(phyUnit), ATHR_DEBUG_PORT_DATA, 0x3d47);
	return (liveLinks > 0);
}
